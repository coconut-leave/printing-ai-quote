...
test('应按时间窗口聚合趋势、漏斗和 productType 拆分', () => {
    ...
    conversations: [
      {
        ...
        messages: [
          ...
          { id: 13, sender: 'ASSISTANT', createdAt: new Date('2026-04-01T10:10:00.000Z'), metadata: { responseStatus: 'quoted', quoteParams: { productType: 'album' }, missingFields: [] } },
        ],
        quotes: [{ id: 201 }],
        handoffs: [],
      },
      {
        ...
        messages: [
          ...
          { id: 22, sender: 'ASSISTANT', createdAt: new Date('2026-03-31T09:10:00.000Z'), metadata: { responseStatus: 'estimated', estimatedData: { finalPrice: 100, normalizedParams: { productType: 'album' } }, missingFields: ['pageCount'] } },
          { id: 23, sender: 'ASSISTANT', createdAt: new Date('2026-03-31T09:15:00.000Z'), metadata: { responseStatus: 'missing_fields', mergedParams: { productType: 'album' }, missingFields: ['pageCount'] } },
        ],
        quotes: [],
        handoffs: [],
      },
      {
        ...
        updatedAt: new Date('2026-04-02T12:00:00.000Z'),
        messages: [
          { id: 31, sender: 'ASSISTANT', createdAt: new Date('2026-04-02T08:00:00.000Z'), metadata: { responseStatus: 'handoff_required', mergedParams: { productType: 'poster' } } },
        ],
        quotes: [],
      ...
      },
      {
        ...
        messages: [
          ...
          { id: 42, sender: 'ASSISTANT', createdAt: new Date('2026-03-20T10:10:00.000Z'), metadata: { responseStatus: 'quoted', quoteParams: { productType: 'flyer' }, missingFields: [] } },
        ],
        quotes: [{ id: 202 }],
        handoffs: [],
      },
  ...
  assert(stats.productTypeBreakdown[0]?.productType === 'album', '应输出 productType 拆分')
  assert(stats.productTypeBreakdown.find((item) => item.productType === 'poster')?.handoffRequiredCount === 1, '应按 productType 统计 handoff_required')
